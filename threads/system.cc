...
//                           Tiempo compartido
//----------------------------------------------------------------------
/*El temporizador provoca que se ejecute una función manejadora cuando
transcurre una cantidad fija o aleatoria de pulsos de reloj. */
...
#ifdef USER_PROGRAM
//El objeto del tipo Timer ha de ser declarado como una 
//variable global del sistema
//Esta instrucción deberá situarse después de que se haya 
//construido el objeto machine de Nachos
    machine = new Machine(debugUserProg);	// this must come first
    timer = new Timer (manejador, 0, 0);
#endif
