...
///////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////
	int value;         		// valor 0 para cerrojo disponible, valor 1 para cerrojo no disponible
    List<Thread*> *queue;   //cola con los hilos que están en espera acquire, porque el cerrojo está cerrado    
                       		
	Thread *hilo;    //hilo que posee el cerrojo
///////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////
///////////////////////variables condición (clase Condition)/////////////////////
/////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////
class Condition {
 public:
...
// hace acquire y release, es decir,
// libera el cerrojo y expulsa al hilo de la CPU.
// El hilo se espera hasta que alguien le hace un Signal()
    void Wait(); 	
// pone un release, es decir, si hay alguien esperando en la variable, despierta a uno
// de los hilos. Si no hay nadie esperando, no ocurre nada.
    void Signal();   
// despierta a todos los de la cola, es decir, despierta a todos los hilos que estan esperando
    void Broadcast();
...
/////////////////////////////////////////////////////////////////////////////////
	// cola
	List<Thread*> *queue;
	// cerrojo, que será necesario para el constructor
	Lock *cerrojo;
};
