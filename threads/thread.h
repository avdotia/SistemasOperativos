...
/*respetamos el actual constructor de la clase y definimos para la planificación 
por prioridades un nuevo constructor (no modificamos el anterior)*/

//----------------------------------------------------------------------

//el constructor nuevo, con el campo prioridad del hilo 
	Thread(const char* Nom_Hilo, int p); 
...
//----------------------------------------------------------------------
//----------------------------------------------------------------------
//campo nuevo de la clase que almacena la prioridad del hilo
	  int prioridad;
